...
class TwoDShape
{
    ...
    TwoDShape(double w, double h)
    {
        width = w;
        height = h;
        cout << "TwoDShape parameterized constructor called" << endl;
    }
};
class Triangle : public TwoDShape
{
    public:
    char style[20];
    Triangle(const char* s, double w, double h) : TwoDShape(w, h)
    {
        strcpy(style, s);
        cout << "Triangle parameterized constructor called" << endl;
    }
    Triangle() : TwoDShape(0.0, 0.0)
    {
        strcpy(style, "none");
